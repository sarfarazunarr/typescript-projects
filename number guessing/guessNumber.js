...
async function guessNumber(range) {
    let attempts = 0; //Attempts to count
    let randomNumber = Math.floor(Math.random() * range) + 1; //Random number from 0 to specified range
    while (true) {
