...
async function convert() {
    ...
    try {
        ...
        let conversionData = await axios.get(`https://v6.exchangerate-api.com/v6/[YOUR_API_KEY]/pair/${data.from}/${data.to}/${data.amount}`);
        let result = conversionData.data.conversion_result; //Conversion result
